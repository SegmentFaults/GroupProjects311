...
public class StructuralTest {
	...
	public static Collection<Object[]> clazzes() throws IOException, JSONException {
	...
	private void checkConstructors(Class<?> clazz,
			JSONArray expectedConstructors) throws JSONException {
	...
	private void checkMethods(Class<?> clazz, JSONObject jsonMethods)
			throws NoSuchMethodException, JSONException {
	...
	private void checkModifiers(int actualModifiers, JSONArray expectedModifiers) throws JSONException {
