...
class Model():
    ...
    def check_win(self, playerToCheck):
        ...
        for x in range(3):
            if self.game_board[x] == playerToCheck and self.game_board[x + 3] == playerToCheck and self.game_board[
                x + 6] == playerToCheck:
                return True
            elif self.game_board[x * 3] == playerToCheck and self.game_board[x * 3 + 1] == playerToCheck and \
                    self.game_board[x * 3 + 2] == playerToCheck:
                return True
        if (self.game_board[0] == playerToCheck and self.game_board[4] == playerToCheck and self.game_board[
            8] == playerToCheck) or (
                self.game_board[2] == playerToCheck and self.game_board[4] == playerToCheck and self.game_board[
            6] == playerToCheck):
            return True
...
class TextView:
    ...
    def printGameBoard(self):
        ...
        print self.controller.determine_game_piece(currentBoard[0]) + " " + self.controller.determine_game_piece(
            currentBoard[1]) + " " + self.controller.determine_game_piece(currentBoard[2])
        print self.controller.determine_game_piece(currentBoard[3]) + " " + self.controller.determine_game_piece(
            currentBoard[4]) + " " + self.controller.determine_game_piece(currentBoard[5])
        print self.controller.determine_game_piece(currentBoard[6]) + " " + self.controller.determine_game_piece(
            currentBoard[7]) + " " + self.controller.determine_game_piece(currentBoard[8])
